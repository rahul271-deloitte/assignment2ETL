...
package hu_ie_de_track.talendemo_0_1;
 ...
 * @status
 */
public class talendemo implements TalendJob {
	...
	private final String jobName = "talendemo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(talendemo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final talendemo talendemoClass = new talendemo();

		int exitCode = talendemoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = talendemo.class.getClassLoader()
					.getResourceAsStream("hu_ie_de_track/talendemo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = talendemo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : talendemo");
		}
...
/************************************************************************************************
 * 26597 characters generated by Talend Open Studio for Data Integration on the
 * May 23, 2022 at 2:50:06 PM IST
 ************************************************************************************************/