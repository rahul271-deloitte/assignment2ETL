...
package hu_ie_de_track.miniassignment_0_1;
 ...
 * @status
 */
public class miniAssignment implements TalendJob {
	...
	private final String jobName = "miniAssignment";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					miniAssignment.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(miniAssignment.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_HU_IE_DE_TRACK_miniAssignment = new byte[0];
		static byte[] commonByteArray_HU_IE_DE_TRACK_miniAssignment = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_HU_IE_DE_TRACK_miniAssignment.length) {
					if (length < 1024 && commonByteArray_HU_IE_DE_TRACK_miniAssignment.length == 0) {
						commonByteArray_HU_IE_DE_TRACK_miniAssignment = new byte[1024];
					} else {
						commonByteArray_HU_IE_DE_TRACK_miniAssignment = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_HU_IE_DE_TRACK_miniAssignment, 0, length);
				strReturn = new String(commonByteArray_HU_IE_DE_TRACK_miniAssignment, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_HU_IE_DE_TRACK_miniAssignment, 0, length);
				strReturn = new String(commonByteArray_HU_IE_DE_TRACK_miniAssignment, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_HU_IE_DE_TRACK_miniAssignment) {
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/rahulsharma685/Downloads/ETLassignment/config.properties";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/rahulsharma685/Downloads/ETLassignment/config.properties", "ISO-8859-15", "=",
...
///////////////////////    			
					...
					if (!((Object) ("C:/Users/rahulsharma685/Downloads/ETLassignment/config.properties") instanceof java.io.InputStream)) {
	...
	public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_HU_IE_DE_TRACK_miniAssignment) {
				...
				try {
					...
					this.order_time = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.order_time, dos);
...
// # Output table : 'out2'
								out2_tmp.Region = row3.Region;
								out2_tmp.Country = row3.Country;
								out2_tmp.Item_Type = row3.Item_Type;
								out2_tmp.Sales_Channel = row3.Sales_Channel;
								out2_tmp.Order_Priority = row3.Order_Priority;
								out2_tmp.Order_Date = row3.Order_Date;
								out2_tmp.Order_ID = row3.Order_ID;
								out2_tmp.Ship_Date = row3.Ship_Date;
								out2_tmp.Units_Sold = row3.Units_Sold;
								out2_tmp.Unit_Price = row3.Unit_Price;
								out2_tmp.Unit_Cost = row3.Unit_Cost;
								out2_tmp.order_time = Mathematical.INT(TalendDate.formatDate("yyyy",
										TalendDate.parseDate("dd/MM/yy", row3.Order_Date)));
								out2 = out2_tmp;
// ###############################
...
///////////////////////		
								...
								if (out2.Region != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Region));
								...
								if (out2.Country != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Country));
								...
								if (out2.Item_Type != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Item_Type));

								} //

								strBuffer_tLogRow_2.append("|");

								if (out2.Sales_Channel != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(out2.Sales_Channel));
								...
								if (out2.Order_Priority != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Order_Priority));
								...
								if (out2.Order_Date != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Order_Date));
								...
								if (out2.Order_ID != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Order_ID));
								...
								if (out2.Ship_Date != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Ship_Date));
								...
								if (out2.Units_Sold != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(out2.Units_Sold));
								...
								if (out2.Unit_Price != null) { //
									...
									strBuffer_tLogRow_2.append(FormatterUtils.formatUnwithE(out2.Unit_Price));
								...
								if (out2.Unit_Cost != null) { //
									...
									strBuffer_tLogRow_2.append(FormatterUtils.formatUnwithE(out2.Unit_Cost));

								} //

								strBuffer_tLogRow_2.append("|");

								if (out2.order_time != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(out2.order_time));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final miniAssignment miniAssignmentClass = new miniAssignment();

		int exitCode = miniAssignmentClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = miniAssignment.class.getClassLoader()
					.getResourceAsStream("hu_ie_de_track/miniassignment_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = miniAssignment.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : miniAssignment");
		}
...
/************************************************************************************************
 * 107915 characters generated by Talend Open Studio for Data Integration on the
 * May 24, 2022 at 7:39:47 PM IST
 ************************************************************************************************/