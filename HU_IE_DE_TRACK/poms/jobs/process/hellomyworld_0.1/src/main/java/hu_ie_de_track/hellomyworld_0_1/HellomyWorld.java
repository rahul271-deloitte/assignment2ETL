...
package hu_ie_de_track.hellomyworld_0_1;
 ...
 * @status
 */
public class HellomyWorld implements TalendJob {
	...
	private final String jobName = "HellomyWorld";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HellomyWorld.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = "Hello world from Rahul!";
	...
	public static void main(String[] args) {
		final HellomyWorld HellomyWorldClass = new HellomyWorld();

		int exitCode = HellomyWorldClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HellomyWorld.class.getClassLoader()
					.getResourceAsStream("hu_ie_de_track/hellomyworld_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = HellomyWorld.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HellomyWorld");
		}
...
/************************************************************************************************
 * 26650 characters generated by Talend Open Studio for Data Integration on the
 * May 23, 2022 at 3:32:00 PM IST
 ************************************************************************************************/